...
CREATE TABLE Tasks(
    ...
    beingDoneAt DATETIME DEFAULT NULL, -- TODO trigger on statusId update to 2, CURRENT_TIMESTAMP
    ...
    beingDoneBy INTEGER DEFAULT NULL,
    doneBy      INTEGER DEFAULT NULL,

    FOREIGN KEY (targetId) REFERENCES Users(id),
    FOREIGN KEY (areaId) REFERENCES Areas(id),
    FOREIGN KEY (statusId) REFERENCES TaskStatuses(id),
    FOREIGN KEY (createdBy) REFERENCES Users(id),
    FOREIGN KEY (beingDoneBy) REFERENCES Users(id),
    FOREIGN KEY (doneBy) REFERENCES Users(id)
);
